"""
Django settings for AgapetBack project.
...
SECRET_KEY = 'django-insecure-lkcbh0-p-1isp&(a8nn8^9600p4&375s-mxtox0sm=92&got-@'
...
WSGI_APPLICATION = 'AgapetBack.wsgi.application'
